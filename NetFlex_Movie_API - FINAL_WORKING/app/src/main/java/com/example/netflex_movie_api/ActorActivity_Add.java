...
public class ActorActivity_Add extends AppCompatActivity {
    ...
    private Button btnsubmit_actor, btnchoose_actor, btncapture_actor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnchoose_actor = (Button)findViewById(R.id.btnchoose_actor);
        btncapture_actor = (Button)findViewById(R.id.btncapture_actor);
